  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <ul className="mt-[282px] flex h-5 w-screen items-center justify-start text-xs text-white transition-all duration-300 md:mt-[210px] md:text-sm lg:mt-[290px] lg:h-auto">
            <li>
